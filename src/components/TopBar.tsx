    ...
    >
      ...
      <div className="flex items-center gap-5">
        ...
        >
          ...
          <span className="text-sm font-semibold text-gradient-warm">{streak} Day Streak</span>
        </motion.div>

        {/* Notifications */}
        <motion.button whileHover={{ scale: 1.1 }} className="relative p-2 text-muted-foreground hover:text-foreground transition-colors">
          <Bell className="w-5 h-5" />
          <span className="absolute top-1 right-1 w-2 h-2 rounded-full bg-primary animate-pulse" />
        </motion.button>

        {/* Avatar */}
        <motion.div whileHover={{ scale: 1.05 }} className="flex items-center gap-3 glass rounded-full pl-1 pr-4 py-1 cursor-pointer">
